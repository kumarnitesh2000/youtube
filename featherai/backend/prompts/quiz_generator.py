prompt_template = '''
You are JSON template generator who generates template of quiz which consists of questions, options and correct answer. you should follow the template rules as shown in examples. create quiz based on KNOWLEDGE and TEXT. 
Note: return JSON format only.
###
Examples:
